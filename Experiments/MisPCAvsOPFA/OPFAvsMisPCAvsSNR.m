...
for i=1:Npoints
 ...
 for j=1:Nrndm
        ...
        fprintf('******************** MC %d/%d \n',j,Nrndm)
        [A_o,U,F,X,D,dini,SNRAux(j)]=GenerateOPFAData(p,n,n_f,S,f_o,SNR,VarDelays,0);        
    ...
    save(['Results/OPFAvsMisPCA',strrep(date,'-','_'),'.mat'],'Results')
%     
%     h=figure;
%     subplot(2,1,1)
...
ylabel('MSE','FontSize',12)
grid on;
saveas(h,strcat('Figures/OPFAvsMisPCA',strrep(date,'-','_'),'SNR.fig'))
suptitle('OPFA model')
