...
r=p/100;
[dummy1,dummy2,H]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmax,Spacing,[],[]);

%% Experiments r=p/100
eigsRh1=cell(NpointsN,1);
for l=1:NpointsN
    fprintf('\n dmax=%d \n',dmaxVec(l))
    [dummy1,dummy2,dummy3,d]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmaxVec(l),Spacing,[],H);
    [dummy1,dummy2,PredictedBias(l),dummy3,dummy4,eigsRh1{l}]=SubspaceDistanceAndPredictedDistance(H,H,d);
 ...
 for i=1:Nrndm
            %% Rank-F signal
            [dummy1,S,dummy2,dummy3]=GenerateFMisPCAData(p,1,n,f_o,SNR(k),r,dmaxVec(l),Spacing,[],H);           
...
r=p/10;
[dummy1,dummy2,H2]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmax,Spacing,[],[]);

%% Experiments r=p/10

for l=1:NpointsN
    fprintf('\n dmax=%d \n',dmaxVec(l))
    [dummy1,dummy2,dummy3,d]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmaxVec(l),Spacing,[],H2);
    [dummy1,dummy2,PredictedBias2(l),dummy3,dummy4,eigsRh2{l}]=SubspaceDistanceAndPredictedDistance(H2,H2,d);
 ...
 for i=1:Nrndm
            %% Rank-F signal
            [dummy1,S,dummy2,dummy3]=GenerateFMisPCAData(p,1,n,f_o,SNR(k),r,dmaxVec(l),Spacing,[],H2);           
            [FPCA,Lambda]=eigs(S,f_o);
...
r=p/2;
[dummy1,dummy2,H3]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmax,Spacing,[],[]);

%% Experiments r=p/2

for l=1:NpointsN
    fprintf('\n dmax=%d \n',dmaxVec(l))
    [dummy1,dummy2,dummy3,d]=GenerateFMisPCAData(p,1,n,f_o,SNR(1),r,dmaxVec(l),Spacing,[],H3);
    [dummy1,dummy2,PredictedBias3(l),dummy3,dummy4,eigsRh3{l}]=SubspaceDistanceAndPredictedDistance(H3,H3,d);
 ...
 for i=1:Nrndm
            %% Rank-F signal
             [dummy1,S,dummy2,dummy3]GenerateFMisPCAData(p,1,n,f_o,SNR(k),r,dmaxVec(l),Spacing,[],H3);           
            [FPCA,Lambda]=eigs(S,f_o);
